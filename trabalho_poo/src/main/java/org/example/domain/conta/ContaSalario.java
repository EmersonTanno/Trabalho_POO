...
public class ContaSalario extends Conta implements SaldoService {

    public ContaSalario(Integer numeroConta, Pessoa titular1, Double saldo) throws ContaTitularesException, ContaSaldoInicialException {
        super(numeroConta, titular1);
        setTipoConta(TipoConta.SALARIO);
        if(saldo < 0.00){
    ...
    public ContaSalario(Integer numeroConta, Pessoa titular1, Pessoa titular2, TipoVinculo tipoVinculo, Double saldo) throws ContaTitularesException, PessoaVinculoException, ContaSaldoInicialException {
    ...
    public ContaSalario(Integer numeroConta, Empresa empresa, Double saldo) throws ContaSaldoInicialException {
